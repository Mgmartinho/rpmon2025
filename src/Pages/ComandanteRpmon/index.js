  ...
  <div class="container fixed-page">
    ...
    <div class="row">
      <div class="col-md-5 col-12 mb-4">
        <h3 class="text-dark">Ten. Cel. André Frisenes</h3>
        <a href='/comandante'>
      ...
      <div class="col-md-7 col-12 mb-4 pt-2 overflow-custom text-justify">
        ...
        <ul>
          ...
          <li>Instrutor de Equitação no Exército do Uruguai – 30/11/2012</li>
          <li>CAO – Curso de Aperfeiçoamento de Oficiais – 01/08/2016</li>
          <li>Curso Internacional de Multiplicador de Polícia Comunitária – 14/08/2017</li>
          ...
          <li>Pós-graduação Lato Sensu em Filosofia do Exercício – EPM – Inacabado</li>
        ...
        <ul>
          ...
          <li>Colar “Cadete PM Ruytemberg Rocha” - 1º Grau – 31/10/2013</li>
...
export default ComandantesRpmon